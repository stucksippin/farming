...
const faqData = [
    ...
    },
    {
        ...
        answer: "Закупочные цены зависят от класса: фуражная от 10000 руб/т, 3-й класс от 13000 руб/т, 4-й класс от 13500 руб/т. Актуальные цены уточняйте по телефону."
    },
    {
    ...
    },
    {
        ...
        answer: "Продаем зерно нового урожая с августа 2026. Возможно бронирование партий. Качество подтверждено лабораторными анализами."
    }
];
