    ...
    const applications = [
        {
            ...
            description: 'Высокое содержание клейковины обеспечивает отличное качество хлебобулочных изделий',
            icon: '🍞'
        },
        {
            title: 'Производство муки',
            description: 'Подходит для мукомольных предприятий, стабильные показатели качества',
            icon: '⚙️'
        },
        {
            title: 'Комбикормовая промышленность',
            description: 'Фуражная пшеница для производства высококачественных кормов',
            icon: '🐄'
        },
        {
        ...
        <div className="min-h-screen bg-gradient-to-b from-[#1a0e08] to-[#263C28]">
                    ...
                    <div>
                        ...
                        <div className="bg-gradient-to-r from-[#F7C35F]/10 to-transparent rounded-xl p-6 mb-6 border-l-4 border-[#F7C35F]">
                            <p className="text-[#EADCC1] text-lg leading-relaxed">
                                Продовольственная и фуражная пшеница 3-4 класса от фермерского хозяйства Великанова.
                                Высокое содержание клейковины, оптимальная влажность. Идеально подходит для мукомольных
                                предприятий, хлебопекарной и комбикормовой промышленности.
                            </p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-[#2c1810]/70 to-[#1a0e08]/70 backdrop-blur rounded-2xl p-6 mb-6 border border-[#F7C35F]/30">
                            ...
                            <div className="text-xs text-[#EADCC1]/50">
                                * Окончательная цена зависит от объёма партии и условий доставки
                            </div>
                        </div>
                        ...
                        {activeTab === 'description' && (
                            <div className="space-y-6">
                                <span className="text-2xl font-bold text-[#F7C35F] mb-4">
                                    Пшеница от фермерского хозяйства Великанова
                                </span>

                                <p className="text-[#EADCC1] leading-relaxed">
                                    Наше фермерское хозяйство специализируется на выращивании высококачественной пшеницы
                                    в Тацинском районе Ростовской области — одном из самых плодородных регионов России.
                                    Благодаря благоприятным климатическим условиям и использованию современных агротехнологий,
                                    мы получаем зерно с отличными показателями качества.
                                </p>

                                <div className="bg-[#F7C35F]/5 rounded-lg p-6 border-l-4 border-[#F7C35F]">
                                    <span className="text-xl font-semibold text-[#F7C35F] mb-3">
                                        Преимущества нашей пшеницы
                                    </span>
                                ...
                                <p className="text-[#EADCC1] leading-relaxed">
                                    Мы тщательно контролируем весь процесс выращивания — от подготовки почвы до уборки урожая.
                                    Каждая партия проходит лабораторный контроль качества. Предоставляем полный пакет документов:
                                    сертификаты соответствия, декларации качества, фитосанитарные сертификаты.
                                </p>
                            </div>
                        )}
                            ...
                            <div>
                                ...
                                <div className="mt-8 bg-[#F7C35F]/5 rounded-lg p-6 border border-[#F7C35F]/30">
                                    ...
                                    <p className="text-[#EADCC1] mb-4">
                                        Наши специалисты помогут подобрать оптимальный вид пшеницы для ваших задач
                                        и проконсультируют по техническим вопросам.
                                    </p>
                                    <a
                                        href="tel:+79281789282"
                ...
                <div className="max-w-4xl mx-auto space-y-4">
                    {[
                        ...
                        },
                        {
                            ...
                            a: 'Да, каждая партия сопровождается полным пакетом документов: сертификатом соответствия, декларацией качества, результатами лабораторных исследований и фитосанитарным сертификатом.'
                        },
                        {
            ...
            <section className="farm_container mx-auto px-4 py-16">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    ...
                    >
                        <div className="text-6xl mb-4"><Image src={flax_seed} alt='семена льна' /></div>
                        <span className="text-2xl font-bold text-[#F7C35F] mb-3 group-hover:text-[#e5b44f]">
                            Лен масличный
                        </span>
                        <p className="text-[#EADCC1]/80 mb-4">
                            Высококачественное сырьё для производства масла с высокой масличностью
                        </p>
