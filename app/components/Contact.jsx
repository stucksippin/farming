...
export default function Contact() {
    ...
    return (
        <div className='bg-[#263C28] pt-11'>
            <h3 id='contact' className='text-white text-center text-8xl mb-[200px] font-extrabold product_main_title'>КОНТАКТЫ</h3>
            <div className='flex justify-around'>

                <div>
                    <div className='mb-[80px] flex flex-col'>
                        <span className='text-[#F7C35F] text-[48px] mb-[15px] contact_label-text'>Номер</span>
                        <span className='text-[40px] text-white contact_mean-text'>+7 928 178-92-82</span>
                    </div>
                    <div className='mb-[80px] flex flex-col'>
                        <span className='text-[#F7C35F] text-[48px] mb-[15px] contact_label-text'>Почта</span>
                        <span className='text-[40px] text-white contact_mean-text'>example@mail.ru</span>
                    </div>
                    <div className='mb-[80px] flex flex-col'>
                        <span className='text-[#F7C35F] text-[48px] mb-[15px] contact_label-text'>Адрес</span>
