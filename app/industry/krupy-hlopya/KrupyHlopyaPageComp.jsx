...
const advantages = [
    { title: 'Контроль качества каждой партии', text: 'Лабораторный анализ натурного веса, влажности, стекловидности и сорной примеси перед отгрузкой. Протокол передаётся вместе с партией.' },
    { title: 'Стабильность между поставками', text: 'Согласованные показатели фиксируем в договоре. Каждая следующая партия — в пределах допуска для вашей линии.' },
    { title: 'Подбор под технические требования', text: 'Уточняем требования к натурному весу, стекловидности и крупности зерна под конкретный тип крупяного производства.' },
...
const expertiseSteps = [
    { num: '01', title: 'Уточняем технологические параметры', text: 'Запрашиваем требования по натурному весу, стекловидности, крупности зерна и допустимому содержанию примесей под вашу линию.' },
...
const specifications = [
    {
        product: 'Пшеница 3 класс (крупяная)',
        purpose: 'Производство манной крупы, булгура, кускуса',
        params: 'Натурный вес ≥ 750 г/л, стекловидность ≥ 60%, влажность ≤ 14%',
        delivery: 'Авто, EXW/FCA',
    },
    {
        product: 'Пшеница 3–4 класс (пшеничные хлопья)',
        purpose: 'Производство пшеничных хлопьев и каш быстрого приготовления',
        params: 'Натурный вес ≥ 730 г/л, влажность ≤ 14%, сорная примесь ≤ 1%',
        delivery: 'Авто, EXW/FCA',
    },
    {
        product: 'Пшеница отборная (высокий натурный вес)',
        purpose: 'Производство премиальных круп и специальных продуктов',
        params: 'По согласованной спецификации, натурный вес ≥ 770 г/л',
...
const reviews = [
    {
        id: 1,
        name: 'Олег Захаров',
        role: 'Технолог крупяного цеха',
        location: 'Ростов-на-Дону',
        date: 'Февраль 2026',
        rating: 5,
        text: 'Для нашей линии булгура нужна пшеница с высоким натурным весом и стекловидностью. КФХ Великанов выдерживает эти параметры стабильно — за два сезона не было ни одной партии с отклонением.',
    },
    {
        id: 2,
        ...
        date: 'Январь 2026',
        rating: 5,
        text: 'Берём пшеницу под хлопья. Важно, что влажность и сорность строго в норме — на нашей линии это критично. Документы в порядке, отгрузка по графику.',
    },
    {
        id: 3,
        name: 'Павел Рыбаков',
        ...
        date: 'Декабрь 2025',
        rating: 5,
        text: 'Работаем второй сезон. Ценю, что параметры прописывают в договоре и не отходят от них. Для нашего производства стабильность сырья — это стабильность готового продукта.',
    },
];
...
export default function KrupyHlopyaPageComp() {
    return (
        <div className="min-h-screen bg-[#263C28]">
            <div className="farm_container px-4 py-6">
                <nav className="flex items-center gap-2 text-sm text-[#EADCC1]/60 flex-wrap">
                    ...
                    <ChevronRight className="w-3 h-3" />
                    <span className="text-[#F7C35F]">Производители круп и хлопьев</span>
                </nav>
            </div>
            ...
            <section className="farm_container px-4 pt-4 pb-16 md:pb-20">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                        <span className="inline-block px-4 py-1.5 bg-[#F7C35F]/15 border border-[#F7C35F]/30 rounded-full text-[#F7C35F] text-sm font-semibold mb-6">🥣 Для производителей круп и хлопьев</span>
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#F7C35F] leading-tight mb-6">
                            Зерно и сырье для производства круп и хлопьев
                        </h1>
                        <p className="text-[#EADCC1] text-lg leading-relaxed mb-8">
                            КФХ Великанов поставляет пшеницу 3 класса с высоким натурным весом и стекловидностью производителям круп и хлопьев. Каждая партия — с лабораторным протоколом. Показатели фиксируем в договоре.
                        </p>
                    ...
                    <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.15 }} className="grid grid-cols-2 gap-4">
                        {[
                            { value: '≥750', label: 'натурный вес', sub: 'г/л, пшеница 3 кл.' },
                            { value: '≥60%', label: 'стекловидность', sub: 'для круп' },
            ...
            <section className="farm_container px-4 py-16 md:py-20">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#F7C35F] mb-4">Почему производители круп и хлопьев выбирают нас?</h2>
                    <p className="text-[#EADCC1]/70 text-lg max-w-2xl">Для крупяного производства критичны натурный вес и стекловидность зерна. Отклонение по этим параметрам напрямую влияет на выход и качество готовой продукции.</p>
                </motion.div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <section className="farm_container px-4 py-16 md:py-20">
                <div className="bg-gradient-to-br from-[#2c1810]/40 to-[#1a0e08]/40 border border-[#F7C35F]/20 rounded-3xl p-8 md:p-12">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-10">
                        ...
                        <p className="text-[#EADCC1]/70 text-lg max-w-2xl">Пшеница для круп — это не просто «3 класс». Разные типы продукции требуют разных показателей стекловидности, натурного веса и содержания примесей. Мы работаем с вашими техническими требованиями.</p>
                    </motion.div>
            ...
            <section className="farm_container px-4 py-16 md:py-20">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-10">
                    ...
                    <p className="text-[#EADCC1]/70">Статьи о качестве пшеницы, показателях зерна и агрономических нюансах.</p>
                </motion.div>
            ...
            <section className="farm_container px-4 py-16 md:py-20">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-10">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#F7C35F] mb-4">Нам доверяют производители круп и хлопьев</h2>
                    <p className="text-[#EADCC1]/70">Акцент — на стабильность натурного веса и предсказуемость каждой следующей поставки.</p>
                </motion.div>
            ...
            <section className="farm_container px-4 pb-24">
                <div className="bg-gradient-to-r from-[#F7C35F]/15 via-[#F7C35F]/10 to-[#F7C35F]/5 border border-[#F7C35F]/30 rounded-3xl p-10 md:p-14 text-center">
                    ...
                    <p className="text-[#EADCC1]/70 mb-8 max-w-xl mx-auto leading-relaxed">Оставьте заявку — уточним класс, натурный вес, объём и сроки. Ответим в рабочее время в день обращения.</p>
